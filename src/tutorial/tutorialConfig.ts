...
const mapNavigationModule: TutorialModule = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: 'You can now navigate systems, inspect Assets, and read Tags. Continue through the tutorials to learn about asset abilities and expand influence.',
...
const assetManagementModule: TutorialModule = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: 'Return to the Sector Map and select the world where the new Asset spawned. World details let you use asset abilities or issue Attack commands.',
    ...
    {
      id: 'use-movement-ability',
      title: 'Move Assets with Abilities',
      body: 'In SWN, movement happens through asset abilities. Assets with movement capabilities (like Smugglers, Strike Fleets, etc.) have special abilities that allow movement. Use the "Ability" button on assets with movement powers.',
      targetSelectors: ['.world-details__asset-item'],
      highlightPadding: 14,
      completionEvent: 'assetTutorial.assetSystemSelected',
    },
    {
