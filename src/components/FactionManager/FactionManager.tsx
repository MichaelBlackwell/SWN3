...
export default function FactionManager() {
  ...
  const summaryStats = useMemo(() => {
    ...
    const totalStrength = factions.reduce(
      (sum: number, faction: Faction) =>
        sum + faction.attributes.force + faction.attributes.cunning + faction.attributes.wealth,
      0
    );
              ...
              factions.map((faction: Faction) => (
                ...
                >
                  ...
                  <div className="faction-card__metrics">
                    <div>
                      <KeywordTooltipText as="span" text="Assets" />
                    ...
                    <div>
                      <span>Strength</span>
                      <strong>{faction.attributes.force + faction.attributes.cunning + faction.attributes.wealth}</strong>
                    </div>
                  </div>
